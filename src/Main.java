        ...
        while (!equationTypeInput.equalsIgnoreCase("quit")){
            ...
            switch (equationTypeInput){
                case ("1"): {
                    ...
                    String mainInput = "";
                    while (!mainInput.equalsIgnoreCase("return")) {
                        ...
                        if (mainInput.equalsIgnoreCase("return")) {
                            System.out.println();
                            break;
                        }
                ...
                case ("2"): {
                    System.out.println("\n" + "Type \"return\" to go back");
                    System.out.println("\"quit\" command will not work here");
                    System.out.println("Input a compound to compute its percent composition");
                    String mainInput = "";
                    while (!mainInput.equalsIgnoreCase("return")) {
                        System.out.print("Equation or Compound Input: ");
                        Scanner mainCompoundInput = new Scanner(System.in);
